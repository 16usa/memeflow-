...
PATCH='MEMEFLOW_WS_ONLY_PREOPEN_RPC_V1_2'
...
run(['git','commit','-m','[MEMEFLOW_WS_ONLY_PREOPEN_RPC_V1_2] Verified WS-only cleanup on f1cf83c8'],cwd=root)
run(['git','push','origin','HEAD'],cwd=root)

print()
print('='*76)
print(' MEMEFLOW_WS_ONLY_PREOPEN_RPC_V1_2 INSTALLED SUCCESSFULLY')
print('='*76)
