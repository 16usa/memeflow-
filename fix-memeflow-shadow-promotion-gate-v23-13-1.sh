...
echo "=== MEMEFLOW SHADOW PROMOTION GATE V23.13.1 INSTALLER ==="
...
# Normalize generated files to exactly one final newline.
# This prevents git diff --check from rejecting a blank line at EOF.
python3 - <<'PY'
from pathlib import Path
for name in [
    "memeflow-app/src/shadow-promotion-gate-v23_13.mjs",
    "memeflow-app/tests/shadow-promotion-gate-v23_13.mjs"
]:
    p=Path(name)
    p.write_text(
...
print("V23_13_EOF_NORMALIZATION_OK")
PY
