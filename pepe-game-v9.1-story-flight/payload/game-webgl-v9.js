...
/* V9.1: use DOM rocket as the story hero; keep WebGL for the scene only. */
...
window.PepeRocketWebGLV9={version:'9.0',renderer:'WebGL 2.5D',layers:11,get ready(){return world.classList.contains('webgl-ready')}};
})();