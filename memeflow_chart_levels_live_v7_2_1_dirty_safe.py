...
TAG="MEMEFLOW_CHART_LEVELS_LIVE_V7_2_1_DIRTY_SAFE"
...
def main():
    ...
    try:
        ...
        html,n=re.subn(
            r'src="/trading\.js(?:\?[^"]*)?"',
            'src="/trading.js?v=chart-levels-live-v7-2-1-20260829"',
            original_html,
            count=1
        )
        if n!=1:
        ...
        checks={
            ...
            "TP1 level": "`TP1 +${fmt(tp1,0)}%`" in final_js,
            "TP2 level": "`TP2 +${fmt(tp2,0)}%`" in final_js,
            ...
            "cache bust":
                "/trading.js?v=chart-levels-live-v7-2-1-20260829"
                in final_html,
        }
