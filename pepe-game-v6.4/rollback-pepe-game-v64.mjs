...
const fail=m=>{console.error('PEPE GAME V6.4 ROLLBACK: FAIL · '+m);process.exit(1)};

if(!fs.existsSync(latest))fail('no V6.4 backup metadata found');
...
console.log('Pepe Rocket V6.4 rollback: PASS');
console.log('Restored V6.3 visual files only. Trading/server files untouched.');
