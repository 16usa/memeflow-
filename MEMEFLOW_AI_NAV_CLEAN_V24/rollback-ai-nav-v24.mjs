...
if (!target) {
  console.error('ROLLBACK v24: index.html not found.');
  process.exit(1);
}
...
if (!fs.existsSync(backup)) {
  console.error('ROLLBACK v24: backup not found.');
  process.exit(1);
}
...
console.log(`ROLLBACK v24 OK: restored ${path.relative(root,backup)}`);
