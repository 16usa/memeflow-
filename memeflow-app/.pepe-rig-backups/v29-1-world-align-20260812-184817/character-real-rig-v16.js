  ...
  */
  ...
  function installLeftGreenAnchorV29() {
    ...
    */
    ...
    /*
      Convert that exact texture point into
      wristJoint-local space.
    */
    ...
    hand.wristJoint.worldToLocal(
      greenAnchor
    );

    /*
      Move only enough to put the green wrist
      anchor exactly at wristJoint origin.
    */

    hand.pivot.position.sub(
      greenAnchor
    );
    ...
    */
    ...
    console.log(
      '[PEPE V29] LEFT GREEN WRIST ACTIVE'
    );
  }
