  ...
  */
  ...
  function installLeftGreenAnchorV29() {
    ...
    if (
      ...
      throw new Error(
        '[PEPE V29] left wrist data unavailable'
      );
    }
    ...
    /*
      ...
      Use the real green wrist shaft from hand_right.png.

      No axis push.
      No synthetic ball.
      No painted plug.
      No manual screen X/Y.

      The green wrist anchor is aligned directly
      with the existing wristJoint.
    */
    ...
    if (
      ...
      throw new Error(
        '[PEPE V29] hand texture unavailable'
      );
    }

    /*
      Build the visible front hand.

      Remove the hand sprite's own top cuff/opening.
      Keep the real green wrist shaft below it.
    */
    ...
    /*
      Real green shaft center in hand_right.png.

      The black opening is around y=25.
      The green wrist shaft runs below it.

      Anchor the middle of that green shaft.
    */

    
    /*
      V29_1_WORLD_DELTA_FIX

      The previous version mixed wristJoint-local
      coordinates with pivot-parent coordinates.

      Resolve both points in world space first,
      calculate the exact world delta, then convert
      the target pivot position back into the pivot
    ...
    */
    ...
    if (!pivotParent) {
      throw new Error(
        '[PEPE V29.1] hand pivot parent unavailable'
      );
    }
    ...
    console.log(
      '[PEPE V29.1] LEFT WRIST ALIGN ERROR',
      alignmentError
    );
    ...
    */
    ...
    /*
      Original sleeve rim stays above the real hand.
    */
    ...
    console.log(
      '[PEPE V29.1] LEFT GREEN WRIST WORLD ALIGNED'
    );
  }
