...
export function createPepeRealRigV16({ parent, baseUrl='/game-assets/character-v16/' }={}) {
  if (!parent) throw new Error('[PEPE V26] LEFT SOLID WRIST');
  ...
  */
  ...
  function installLeftSolidWristV26() {
    ...
    if (
      ...
      throw new Error(
        '[PEPE V26] left wrist data unavailable'
      );
    }

    /*
      V26 LEFT SOLID WRIST

      Do not move the hand.
      Do not rotate the hand.
      Do not modify the wrist joint.

      hand_right.png contains its own black opening.
      Fill only that black opening with color sampled
      from the original green wrist surface.
    */
    ...
    if (
      ...
      throw new Error(
        '[PEPE V26] hand texture unavailable'
      );
    }
    ...
    /*
      Measured center of the black cuff opening
      in hand_right.png.
    */
    ...
    for (
      ...
      for (
        ...
        /*
          Sample the green front wall of the same
          wrist sprite directly below the opening.
        */
        ...
        /*
          Safe fallback if the sampled source pixel
          is transparent or too dark.
        */
    ...
    */
    ...
    /*
      Keep only the original sleeve rim above
      the actual hand.
    */
    ...
    console.log(
      '[PEPE V26] LEFT SOLID WRIST ACTIVE'
    );
  }
  ...
  const ready = Promise.all(defs.map(addPart)).then(() => {
    ...
    */
    installLeftSolidWristV26();

    console.log('[PEPE V26] LEFT SOLID WRIST');
    return true;
  });
