...
export class GameEngine {
  ...
  pickCandidate(uid) {
    ...
    const diag = {
      ...
      noPrice: 0, stalePrice: 0, futurePrice: 0, staleDecision: 0, futureDecision: 0, staleHolders: 0, staleHolderAge: 0, futureHolder: 0, decisionBehindPrice: 0, decisionBehindHolder: 0, eligible: 0, selectedMint: null,
    };
    ...
    for (const decision of decisions) {
      ...
      rows.push({ decision, token, mint, price, score, selectorScore, priceAt: pAt, holderAt: hAt, decisionAt: dAt, priceAgeMs: pAge, holderAgeMs: hAge, decisionAgeMs: dAge });
      diag.eligible++;
    }
