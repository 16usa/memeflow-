...
import { createMotionController } from '/motion-controller.js?v=34207';
import { createRocketRideV34 } from '/rocket-ride-v34.js?v=34207';
...
const labels={up:'UP · BOOST / FULL HEAD',idle:'IDLE · CRUISING / FULL HEAD',down:'DOWN · DESCENT / WORRIED'};
...
ride.ready.then(()=>{ready=true;set('idle');requestAnimationFrame(()=>{resizeCanvas();fitModel();frame();});}).catch(err=>{console.error('[PEPE ROCKET V34.2]',err);label.textContent='LOAD ERROR';document.body.dataset.error='1';});
