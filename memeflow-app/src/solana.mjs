 ...
 */
export function shouldExcludeMayhemCreate(result, enabled=true) {
...
export function decodePumpCreate(ix, keys) {
  ...
  // Parse official Pump create/create_v2 instruction data.
  ...
  const kind=discKey===DISC_CREATE?'create':'create_v2';
