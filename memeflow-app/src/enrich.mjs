...
export function makeHolderMetrics() {
  return {
    ...
    holderSchedulerSkippedNotNeeded: 0,
    holderSchedulerSkippedFresh: 0,
    holderSchedulerSkippedBusy: 0,
    holderSchedulerEnqueueRejected: 0,
    fastHolderSchedulerSelected: 0,
    fastHolderSchedulerStarted: 0,
    fastHolderSchedulerSkippedNoCapacity: 0,
    fastHolderSchedulerSkippedNoCandidates: 0,
