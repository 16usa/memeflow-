...
export function makeDiscoveryMetrics() {
  return {
    ...
    directCreateDecoded: 0,
    directCreateDecodeFailed: 0,
    storeAdmissionAccepted: 0,
    storeAdmissionRejected: 0,
    storeRamMutationSucceeded: 0,
    registryUpsertQueued: 0,
    earlyDrawdownRejected: 0,
    tombstoneRejected: 0,
    hotPathRpcCalls: 0,
    signaturesQueued: 0,
