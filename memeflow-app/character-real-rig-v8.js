...
export function createPepeSkeletonV8({
  parent,
  baseUrl = '/game-assets/character/'
} = {}) {

  if (!parent) {
    throw new Error('[PEPE V8] parent required');
  }
  ...
  const ready = base.ready.then(() => {
    ...
    */
    ...
    parts.handLeft.mesh.position.y += 208 * UNIT;
    parts.handLeft.mesh.scale.setScalar(1.24);

    parts.handRight.mesh.position.x -= 25 * UNIT;
    parts.handRight.mesh.position.y += 208 * UNIT;
