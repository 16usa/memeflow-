/* MEMEFLOW AI Direct Evaluator Sheet v24.0
...
(() => {
  ...
  if (window.__MEMEFLOW_AI_DIRECT_V24__) return;
  window.__MEMEFLOW_AI_DIRECT_V24__ = true;
...
`;
  ...
  function forceHideLegacyBackend(root) {
    ...
    if (backendOverlay && backendOverlay !== root) {
      backendOverlay.classList.add('mf-ai-v24-backend-hidden');
