...
export function createPepeSkeletonV5({
  ...
  const ready = base.ready.then(() => {
    ...
    */
    ...
    parts.handLeft.mesh.position.x += 18 * UNIT;
    parts.handLeft.mesh.position.y += 55 * UNIT;
    parts.handLeft.mesh.scale.setScalar(1.22);

    parts.handRight.mesh.position.x -= 18 * UNIT;
    parts.handRight.mesh.position.y += 55 * UNIT;
