...
PATCH_ID="MEMEFLOW_GMGN_SORT_STYLE_V25_2_FINAL22"
OLD_VERSION="gmgn-sort-v25-1-20260827"
NEW_VERSION="gmgn-sort-v25-2-final2-20260827"
DO_PUSH=0
...
# Strict V25.1 -> V25.2 FINAL2 prerequisites.
...
BACKUP_DIR=".patch-backups/gmgn-sort-v25-2-final2-$STAMP"
mkdir -p "$BACKUP_DIR"
...
final_css = r'''
/* MEMEFLOW_GMGN_SORT_STYLE_V25_2_FINAL2
...
canonical_test = tests_dir / "token-sort-v25-2-final2.mjs"
...
assert.match(
  html,
  /system-tokens\.js\?v=gmgn-sort-v25-2-final2-20260827/
);

assert.match(
  html,
  /system-tokens\.css\?v=gmgn-sort-v25-2-final2-20260827/
);
...
console.log('token sort v25.2 final2 ok');
''',
    encoding="utf-8"
)
...
for name in sorted(referenced_sort_tests):
    ...
    wrapper.write_text(
        "import './token-sort-v25-2-final2.mjs';\n",
        encoding="utf-8"
    )
...
print("V25.2 FINAL2 visual patch installed.")
...
node --check tests/token-sort-v25-2-final2.mjs

echo "==> [3/7] Canonical sort regression"
node tests/token-sort-v25-2-final2.mjs
...
if html.count(
    "gmgn-sort-v25-2-final2-20260827"
) != 2:
    raise SystemExit(
...
echo
echo "V25.2 FINAL2 validated successfully."
...
if [[ "$DO_PUSH" -eq 1 ]]; then
  echo
  echo "Pushing validated V25.2 FINAL2 commit..."
  git push
else
  echo
