...
if (!target) {
  console.error('ROLLBACK v21: index.html not found.');
  process.exit(1);
}
...
if (!fs.existsSync(backup)) {
  console.error('ROLLBACK v21: backup not found.');
  process.exit(1);
}
...
console.log(`ROLLBACK v21 OK: restored ${path.relative(root,backup)}`);
