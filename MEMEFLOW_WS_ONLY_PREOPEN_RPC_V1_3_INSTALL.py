...
PATCH='MEMEFLOW_WS_ONLY_PREOPEN_RPC_V1_3'
...
run(['git','commit','-m','[MEMEFLOW_WS_ONLY_PREOPEN_RPC_V1_3] Remove final discovery queue recovery reference'],cwd=root)
run(['git','push','origin','HEAD'],cwd=root)

print()
print('='*76)
print(' MEMEFLOW_WS_ONLY_PREOPEN_RPC_V1_3 INSTALLED SUCCESSFULLY')
print('='*76)
