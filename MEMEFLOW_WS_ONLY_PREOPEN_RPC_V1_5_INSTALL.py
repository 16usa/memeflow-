...
PATCH='MEMEFLOW_WS_ONLY_PREOPEN_RPC_V1_5'
...
run(['git','commit','-m','[MEMEFLOW_WS_ONLY_PREOPEN_RPC_V1_5] Make live trade feed strictly WS-only'],cwd=root)
run(['git','push','origin','HEAD'],cwd=root)

print()
print('='*76)
print(' MEMEFLOW_WS_ONLY_PREOPEN_RPC_V1_5 INSTALLED SUCCESSFULLY')
print('='*76)
