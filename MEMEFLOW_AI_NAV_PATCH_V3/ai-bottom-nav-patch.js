/*
  MEMEFLOW — Mobile AI Bottom Navigation Patch v3.0
...
@media (max-width: 820px) {
  ...
  .mobile-nav .mf-ai-nav-button {
    ...
    /* Neutralize the original floating launcher offsets.
       Without this, legacy bottom/right rules still shift a relative element
       far above the navigation bar. */
    top: auto !important;
