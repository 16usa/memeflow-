...
# Ignore untracked installer/zip files in ~/workspace.
# Stop only when tracked project files are actually modified/staged.
if ! git diff --quiet || ! git diff --cached --quiet; then
  echo "ERROR: Tracked project files have uncommitted changes. Nothing changed."
