...
const VERSION='MEMEFLOW_PRIMARY_META_MATCH_V20';

const OLD_PAIRS=[
  ['/* MF_PRIMARY_AVATAR_GLYPH_ALIGN_V19_RENDER_START */','/* MF_PRIMARY_AVATAR_GLYPH_ALIGN_V19_RENDER_END */'],
  ['<!-- MF_PRIMARY_AVATAR_GLYPH_ALIGN_V19_STYLE_START -->','<!-- MF_PRIMARY_AVATAR_GLYPH_ALIGN_V19_STYLE_END -->'],
...
const RENDER_START='/* MF_PRIMARY_META_MATCH_V20_RENDER_START */';
const RENDER_END='/* MF_PRIMARY_META_MATCH_V20_RENDER_END */';
const STYLE_START='<!-- MF_PRIMARY_META_MATCH_V20_STYLE_START -->';
const STYLE_END='<!-- MF_PRIMARY_META_MATCH_V20_STYLE_END -->';
...
const RENDER=`${RENDER_START}
 {
  ...
  if(__mfHead&&__mfName&&__mfScore){
    ...
    __mfHead.classList.add('mf-primary-v20-head');
    if(__mfLeft)__mfLeft.classList.add('mf-primary-v20-left');
    if(__mfScoreBox)__mfScoreBox.classList.add('mf-primary-v20-score');
    if(__mfAvatar)__mfAvatar.classList.add('mf-primary-v20-avatar');
    if(__mfScoreCaption)__mfScoreCaption.classList.add('mf-primary-v20-scorecaption');
    ...
    const __mfApply=()=>{
      ...
      const __capStyle=__mfScoreCaption ? getComputedStyle(__mfScoreCaption) : null;
      const __capH=(__capRect?.height&&Math.max(1,Math.round(__capRect.height)))||14;
      const __capFontSize=__capStyle?.fontSize || '12px';
      const __capLineHeight=(__capStyle?.lineHeight && __capStyle.lineHeight!=='normal') ? __capStyle.lineHeight : __capH+'px';
      const __capWeight=__capStyle?.fontWeight || '400';
      const __capSpacing=__capStyle?.letterSpacing || 'normal';

      __mfHead.style.setProperty('--mf-primary-v20-line-h',__m.lineH+'px');
      __mfHead.style.setProperty('--mf-primary-v20-glyph-h',__m.glyphH+'px');
      __mfHead.style.setProperty('--mf-primary-v20-glyph-top',__m.glyphTop+'px');
      __mfHead.style.setProperty('--mf-primary-v20-cap-h',__capH+'px');
      __mfHead.style.setProperty('--mf-primary-v20-cap-font-size',__capFontSize);
      __mfHead.style.setProperty('--mf-primary-v20-cap-line-height',__capLineHeight);
      __mfHead.style.setProperty('--mf-primary-v20-cap-font-weight',String(__capWeight));
      __mfHead.style.setProperty('--mf-primary-v20-cap-letter-spacing',String(__capSpacing));
      ...
      if(__mfMeta&&__mfScoreCaption){
        __mfMeta.style.fontSize=__capFontSize;
        __mfMeta.style.lineHeight=__capLineHeight;
        __mfMeta.style.fontWeight=String(__capWeight);
        __mfMeta.style.letterSpacing=String(__capSpacing);
      }
    };
    ...
    if(!window.__mfPrimaryV20ResizeBound){
      window.addEventListener('resize',()=>{
        ...
        const __avatar=__left ? [...__left.children].find((el)=>el.id!=='primaryName'&&el.id!=='primaryMeta') || null : null;
        const __scoreBox=__score.parentElement||null;
        const __scoreCaption=__scoreBox
          ? [...__scoreBox.children].find((el)=>el!==__score && /AI\\s*SCORE/i.test(String(el.textContent||'')))
            || [...__scoreBox.children].find((el)=>el!==__score)
            || null
          : null;
        const __meta=document.querySelector('#primary-candidate #primaryMeta');
        ...
        try{
          ...
          if(__x){
            ...
            if(__a+__d>0){
              ...
              __top=__fb>0 ? Math.round((((__rect.height-__fb)/2)+__fa)-__a) : Math.round((__rect.height-__h)/2);
            }
          }
        }catch(_e){}

        __head.style.setProperty('--mf-primary-v20-line-h',Math.round(__rect.height)+'px');
        __head.style.setProperty('--mf-primary-v20-glyph-h',__h+'px');
        __head.style.setProperty('--mf-primary-v20-glyph-top',__top+'px');
        ...
        if(__scoreCaption && __meta){
          const __capStyle=getComputedStyle(__scoreCaption);
          const __capRect=__scoreCaption.getBoundingClientRect();
          const __capH=(__capRect?.height&&Math.max(1,Math.round(__capRect.height)))||14;
          const __capLineHeight=(__capStyle.lineHeight && __capStyle.lineHeight!=='normal') ? __capStyle.lineHeight : __capH+'px';
          __head.style.setProperty('--mf-primary-v20-cap-h',__capH+'px');
          __head.style.setProperty('--mf-primary-v20-cap-font-size',__capStyle.fontSize||'12px');
          __head.style.setProperty('--mf-primary-v20-cap-line-height',__capLineHeight);
          __head.style.setProperty('--mf-primary-v20-cap-font-weight',String(__capStyle.fontWeight||'400'));
          __head.style.setProperty('--mf-primary-v20-cap-letter-spacing',String(__capStyle.letterSpacing||'normal'));
          __meta.style.fontSize=__capStyle.fontSize||'12px';
          __meta.style.lineHeight=__capLineHeight;
          __meta.style.fontWeight=String(__capStyle.fontWeight||'400');
          __meta.style.letterSpacing=String(__capStyle.letterSpacing||'normal');
        }
      },{passive:true});
      window.__mfPrimaryV20ResizeBound=true;
    }
  }
 }
${RENDER_END}`;
...
<style id="mf-primary-meta-match-v20-style">
#primary-candidate .token-head.mf-primary-v20-head{
  ...
  --mf-primary-v20-line-h:64px;
  --mf-primary-v20-glyph-h:54px;
  --mf-primary-v20-glyph-top:5px;
  --mf-primary-v20-cap-h:16px;
  --mf-primary-v20-cap-font-size:12px;
  --mf-primary-v20-cap-line-height:16px;
  --mf-primary-v20-cap-font-weight:400;
  --mf-primary-v20-cap-letter-spacing:normal;
}

#primary-candidate .mf-primary-v20-left{
  display:grid!important;
  grid-template-columns:auto minmax(0,1fr)!important;
  grid-template-rows:var(--mf-primary-v20-line-h) var(--mf-primary-v20-cap-h)!important;
...
#primary-candidate .mf-primary-v20-avatar{
  grid-column:1!important;
  grid-row:1!important;
  align-self:start!important;
  justify-self:start!important;
  width:var(--mf-primary-v20-glyph-h)!important;
  height:var(--mf-primary-v20-glyph-h)!important;
  min-width:var(--mf-primary-v20-glyph-h)!important;
  min-height:var(--mf-primary-v20-glyph-h)!important;
  max-width:var(--mf-primary-v20-glyph-h)!important;
  max-height:var(--mf-primary-v20-glyph-h)!important;
  margin-top:var(--mf-primary-v20-glyph-top)!important;
  overflow:hidden!important;
  position:static!important;
  transform:none!important;
}
#primary-candidate .mf-primary-v20-avatar img,
#primary-candidate .mf-primary-v20-avatar picture,
#primary-candidate .mf-primary-v20-avatar canvas,
#primary-candidate .mf-primary-v20-avatar svg{
  width:100%!important;
  height:100%!important;
  object-fit:cover!important;
}

#primary-candidate .mf-primary-v20-left #primaryName{
...
#primary-candidate .mf-primary-v20-left #primaryMeta{
  grid-column:2!important;
  ...
  overflow:hidden!important;
  text-overflow:ellipsis!important;
  font-size:var(--mf-primary-v20-cap-font-size)!important;
  line-height:var(--mf-primary-v20-cap-line-height)!important;
  font-weight:var(--mf-primary-v20-cap-font-weight)!important;
  letter-spacing:var(--mf-primary-v20-cap-letter-spacing)!important;
  position:static!important;
  transform:none!important;
}
#primary-candidate .mf-primary-v20-left #primaryMeta[hidden]{display:none!important}

#primary-candidate .mf-primary-v20-score{
  display:grid!important;
  grid-template-rows:var(--mf-primary-v20-line-h) var(--mf-primary-v20-cap-h)!important;
  align-items:start!important;
...
#primary-candidate .mf-primary-v20-score #primaryScore{
  grid-row:1!important;
  align-self:start!important;
  margin:0!important;
}
#primary-candidate .mf-primary-v20-scorecaption{
  grid-row:2!important;
  align-self:end!important;
  margin:0!important;
  position:static!important;
...
@media(max-width:430px){
  #primary-candidate .token-head.mf-primary-v20-head{column-gap:10px!important}
  #primary-candidate .mf-primary-v20-left{column-gap:10px!important}
}
</style>
${STYLE_END}`;
...
const backup=target+'.before-primary-meta-match-v20.bak';
...
console.log('Avatar still follows visible score-glyph top/bottom.');
console.log('primaryMeta now copies AI SCORE font-size, line-height, font-weight and letter-spacing.');
