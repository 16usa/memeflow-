...
PATCH_NAME="MEMEFLOW_ANTI_RUG_V1_4_2_EXACT"
...
log "Applying $PATCH_NAME on top of V1.4 + V1.4.1..."
...
new_block=r'''  // MEMEFLOW_ANTI_RUG_V1_4_2_EXACT
  ...
  addGate(
    ...
    __mfDrawdownPct===null?null:__mfPeakSafe,
    __mfDrawdownPct===null
      ? 'peak drawdown data pending'
...
test('moderate deep drawdown plus sell pressure becomes WAITING, never BUY READY',()=>{
  const d=evaluate(base({
    priceSol:0.50,
    peakPriceSol:1,
    buyPressure:0.4,
