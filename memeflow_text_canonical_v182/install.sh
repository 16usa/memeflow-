...
APP="memeflow-app"
WORK=".memeflow-text-canonical-v182-work"
STAMP="$(date +%Y%m%d-%H%M%S)"
BACKUP=".memeflow-text-canonical-v182-backup-$STAMP"
POINTER=".memeflow-text-canonical-v182-last-backup"
...
python3 memeflow_text_canonical_v182/transform.py "$WORK/memeflow-app"
python3 memeflow_text_canonical_v182/audit.py "$WORK/memeflow-app"
...
python3 memeflow_text_canonical_v182/audit.py "$APP"

echo
echo "Installed MEMEFLOW DEEP TEXT CANONICAL V182"
echo "Backup: $BACKUP"
