...
TARGET = APP / "memeflow-x-canonical-v181.css"
...
deduped, removed_count = dedupe_context(assembled)
...
for page in PAGES:
    ...
    html = re.sub(
        ...
        '<link rel="stylesheet" href="/memeflow-x-canonical-v181.css?v=text-canonical-v181-20260922">',
        html,
        flags=re.I,
    )

    if "memeflow-x-canonical-v181.css" not in html:
        if "</head>" not in html:
