...
const root='/home/runner/workspace',app=path.join(root,'memeflow-app'),b=path.join(root,'pepe-game-v9.4.1-stable-new-hero','backup-current');
...
console.log('V9.4 rollback complete.');
